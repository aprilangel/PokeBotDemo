...
public class PokemonAttackCellTest {
	...
	public void testAttack() {
    	...
    	assertEquals("@NoctaliShiny o_O ? /cc @aStrangeCookie @Tenshi @PhoenixWright", cell.ask(bot, new Tweet("Tenshi","#attack #foudre @NoctaliShiny /cc @aStrangeCookie @PhoenixWright")));
